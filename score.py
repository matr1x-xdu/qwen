...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument("--model_name", type=str, description="胜和率评分模型，为qwen3-32b,显存不够可替换为qwen3-8b",default="")
        parser.add_argument("--test_data", type=str, description="测试数据",default="")
        parser.add_argument("--user_out_path", type=str, description="选手模型输出的结果",default="")
        parser.add_argument("--we_out_path", type=str, description="原始模型的输出结果",default="")
